...
public class BecariosB {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("¿Deseas agregar un becario? (S/N): ");
        String respuesta = in.nextLine();
        if (respuesta.equals("S")) {
            while (respuesta.equals("S")) {
                System.out.print("Digita su nombre a continuacion: ");
                String nombre = in.nextLine();
                becarios.agrega(nombre);
                System.out.print("¿Deseas agregar otro becario? (S/N): ");
